  ...
  return (
    <section className="border-y border-border bg-secondary/25 py-12 sm:py-16">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        <h2 className="text-xl leading-snug font-bold break-keep text-text-strong sm:text-3xl">이런 사업자에게 맞습니다</h2>
        ...
        <p className="mt-6 text-sm break-keep text-muted-foreground">반찬·도시락, 꽃·화환, 케이크 등 자체 배송을 하는 사장님들과 함께 검증하고 있습니다.</p>
      </div>
    </section>
  );
}
