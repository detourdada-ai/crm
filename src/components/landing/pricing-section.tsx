  ...
  return (
    <section id="pricing" className="bg-background py-14 sm:py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <h2 className="text-center text-[1.75rem] leading-snug font-bold break-keep text-text-strong sm:text-4xl">
          지금은 베타로 먼저 사용해보세요.
        </h2>
        ...
        <div className="mt-10 rounded-2xl border-2 border-primary/35 bg-primary-soft/20 px-6 py-7 text-center sm:px-10 sm:py-9">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed break-keep text-muted-foreground sm:text-base">
        ...
        <p className="mt-6 text-center text-sm leading-relaxed break-keep text-muted-foreground">
