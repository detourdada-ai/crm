...
export async function GET() {
  ...
  const templateRows: (string | number)[][] = [
    ["주문번호", "주문일시(결제일)", "수취인명", "수취인 연락처", "배송지 주소", "배송메모", "배송일", "상품명", "수량", "단가", "금액"],
    ["ORD-001", "2026-08-25", "홍길동", "010-1234-5678", "서울시 강남구 테헤란로 152", "부재 시 문 앞에 놓아주세요", kstTodayIso(), "제육볶음", 2, 8000, 16000],
  ];
